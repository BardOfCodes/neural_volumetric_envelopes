...
from nve_dev.utils.viz_utils import save_each_plane
...
def main():
    ...
    save_each_plane(model, config, output_directory=args.save_loc, num_samples_per_envelope = 2**18, special_code="")
